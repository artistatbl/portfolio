  ...
  return (
    <PageLayout>
      <div>
          ...
          <p className="text-muted-foreground mb-8 text-sm md:mb-16 md:text-base">Creating the tools I wish existed <a href="https://mantlz.app" target="_blank" rel="noopener noreferrer" className=" bg-orange-200  dark:bg-orange-600 px-1 text-black dark:text-white rounded"><span>mantlz</span></a></p>
