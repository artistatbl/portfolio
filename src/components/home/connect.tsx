        ...
        {links.map((link) => (
          <li key={link.label}>
            <a
              ...
              className="grid w-full grid-cols-[auto_minmax(0,1fr)] items-start gap-x-3 gap-y-1 rounded-[0.9rem] px-1.5 py-3 text-left transition-colors hover:bg-muted/60"
            >
